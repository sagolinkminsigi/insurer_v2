...
export default function HomePage() {
  ...
  return (
    <Layout className={Layout.styles.bg.primary50}>
      <Layout.Header fixed main className={cn('bg-white')}>
        <img
          src={Logo}
          className='mr-auto'
          width={92}
      ...
      <Layout.Body className='text-center'>
        ...
        <div className='typo-b1sb flex flex-col items-center justify-center bg-gray-900 pb-14 pt-[50px]'>
          <FormattedDiv>
            {
        ...
        <div className='flex flex-col items-center bg-gray-900 py-[50px]'>
          <img src={Alert} width={50} height={44.5} />

          <div className='typo-st1sb mb-7 mt-3'>
            <span>피해자가</span>
            <span className='text-negative-200'> 무리한 보상금을 요구 </span>
            <span>할 때</span>
          </div>
          <div className='mx-5 rounded-[14px] bg-primary-50 px-5 py-9 text-left text-gray-900'>
            <div className='typo-st1sb mb-5 text-center'>사고링크는</div>
            <div className='typo-b2sb flex gap-2'>
              <div className='mt-[2px] flex h-4 w-4 items-center justify-center rounded-full bg-primary-400 text-[10px] text-white'>
                1
              </div>
            ...
            <div className='ml-2 h-5 w-[1px] bg-gray-300' />
            <div className='typo-b2sb flex gap-2'>
              <div className='mt-[2px] flex h-4 w-4 items-center justify-center rounded-full bg-primary-400 text-[10px] text-white'>
                2
              </div>
        ...
        <FormattedDiv className='typo-st1sb bg-yellow-100 py-[50px] text-primary-900'>
          {'피해자와의 불필요한 합의로\n시간 낭비하실 필요 없어요.'}
        </FormattedDiv>
        <div className='flex flex-col items-center justify-center gap-[36px] bg-primary-900 pb-[69px] pt-[48px]'>
          <div className='flex items-center gap-1'>
            <img src={Congrat} width={20} height={61} />
            <FormattedDiv className='text-gradient-200 typo-st1sb'>
              {'이제 사고링크 서비스를 통해\n쉽고 빠르게 마무리하세요!'}
            </FormattedDiv>
        ...
        <div className='bg-white pb-[92px] text-left text-gray-900'>
          <div className='p-5'>자주 묻는 질문</div>
        ...
        <BottomSheet>
          <button
            className='typo-b1m mb-5 h-[53px] w-[320px] rounded-full bg-primary-500'
