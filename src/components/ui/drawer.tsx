  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        'fixed inset-x-0 bottom-0 z-50 m-auto mt-24 flex h-auto w-full flex-col'
      )}
    >
      <div className={cn('mx-4 mb-4 rounded-[30px]', className)}>
        <div
          className={'mx-auto mt-4 h-2 w-[36px] rounded-full bg-gray-300'}
          {...props}
        />
        {children}
      </div>
